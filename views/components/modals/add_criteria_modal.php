                ...
                <form id="addCriteriaForm">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="criteria_top5">
                            <label class="form-check-label" for="criteria_top5">Top 5's Criteria</label>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editCriteriaForm">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="edit_criteria_top5">
                            <label class="form-check-label" for="edit_criteria_top5">Top 5's Criteria</label>
                        </div>
                    </div>
